        ...
        <>
          ...
          >
            <div className="flex justify-between items-center mb-5 shrink-0">
              <h2 className="text-2xl font-bold text-teal-300">{moonData.name}</h2>
              <button
                onClick={onClose}
            ...
            <div className="flex-grow overflow-y-auto pr-1.5 space-y-3 scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-gray-800">
              <p className="text-gray-200 whitespace-pre-line leading-relaxed">{moonData.description}</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="flex justify-between items-center mb-4 shrink-0">
              <h2 className="text-xl font-bold text-teal-300 text-center flex-grow pl-7">{moonData.name}</h2>
              <button
                onClick={onClose}
                className="text-gray-300 hover:text-white p-1.5 rounded-full hover:bg-white/10 transition-colors"
                aria-label="Close details"
            ...
            <div className="flex-grow overflow-y-auto pr-1.5 space-y-3 scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-gray-800">
              <p className="text-gray-200 whitespace-pre-line leading-relaxed text-sm">{moonData.description}</p>
            </div>
          </motion.div>
        </>
      )}
